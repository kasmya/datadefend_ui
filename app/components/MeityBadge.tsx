            ...
            <div className="container mx-auto max-w-7xl relative z-10">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-stretch">
                    ...
                    <div className="flex flex-col justify-between">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {stats.map((stat, index) => (
                                <motion.div
                                    ...
                                    className="cyber-glass p-5 text-center hover:border-blue-500/30 transition-all duration-300 group"
                                >
                                    {stat.icon && (
                        ...
                        >
                            <button className="flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 group">
                                Explore Solutions
