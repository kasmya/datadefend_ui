            ...
            <div className="container mx-auto max-w-7xl">
                ...
                <div className="grid lg:grid-cols-2 gap-6 md:gap-8 items-start mt-12 relative">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="bg-white p-6 md:p-8 rounded-3xl border-4 border-[#152645] shadow-xl relative"
                    >
                        {/* Decorative accent */}
                        <div className="absolute -top-2 -left-2 w-10 h-10">
                            <div className="w-full h-full border-l-4 border-t-4 border-[#152645] rounded-tl-2xl"></div>
                        </div>

                        <h3 className="text-xl md:text-2xl font-bold text-[#152645] mb-6">DataDefend</h3>
                        ...
                        <div className="space-y-3">
                            {dataDefendFeatures.map((feature, index) => (
                                ...
                                >
                                    ...
                                    <span className="text-[#152645] text-sm md:text-base">{feature}</span>
                                </motion.div>
                            ))}
                        </div>

                        {/* Bottom decorative line */}
                        <div className="mt-6 pt-3 border-t-2 border-[#152645]"></div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="bg-white p-6 md:p-8 rounded-3xl border-4 border-[#152645] shadow-xl"
                    >
                        <h3 className="text-xl md:text-2xl font-bold text-[#152645] mb-6">Other Softwares</h3>
                        ...
                        <div className="space-y-3">
                            {competitorLimitations.map((limitation, index) => (
                                ...
                                >
                                    ...
                                    <span className="text-gray-600 text-sm md:text-base">{limitation}</span>
                                </motion.div>
                            ))}
                        </div>
